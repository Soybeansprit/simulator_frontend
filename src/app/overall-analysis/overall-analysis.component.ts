...
export class OverallAnalysisComponent implements OnInit {
  ...
  //   //         for(let i=0;i<this.scenes[0].deviceAnalysisResults.length;i++){
  //   //           this.deviceNames.push(this.scenes[0].deviceAnalysisResults[i].deviceName)
  //   //         }
  //   //       }
  ...
  //   //       // this.devicesNeverOff=this.getDevicesNotOff(this.scenes);
  ...
  //   //   for(let i=0;i<scenes[0].deviceAnalysisResults.length;i++){
  //   //     var canOff=false;
  //   //     var canChangeState=false;
  //   //     second:
  //   //     for(let j=0;j<scenes.length;j++){
  //   //       for(let n=0;n<scenes[j].dataTimeValues.length;n++){

  //   //         if(scenes[j].dataTimeValues[n].name===scenes[0].deviceAnalysisResults[i].deviceName){  
  //   //           cSecond:          
  //   //           for(let m=0;m<scenes[j].dataTimeValues[n].timeValues.length;m++){
  //   //             var timeValue=scenes[j].dataTimeValues[n].timeValues[m]
  //   //             if(timeValue[1]>0){
  //   //               canChangeState=true;
  //   //               break cSecond;
  //   //             }
  ...
  //   //           if(canChangeState){
  //   //             third:
  //   //             for(let k=0;k<scenes[j].deviceAnalysisResults.length;k++){
  //   //               if(scenes[0].deviceAnalysisResults[i].deviceName===scenes[j].deviceAnalysisResults[k].deviceName){
  //   //                 if(!scenes[j].deviceAnalysisResults[k].deviceCannotOff.cannotOff){
  //   //                   canOff=true;
  //   //                   break second;
  //   //                 }
  //   //                 break third;
  ...
  //   //       devicesNeverOff.push(scenes[0].deviceAnalysisResults[i].deviceName)
  //   //     }
  //   //   }
  ...
  //   //     for(let j=0;j<scenes.length;j++){
  //   //       third:
  //   //       for(let k=0;k<scenes[j].dataTimeValues.length;k++){
  //   //         if(scenes[0].deviceAnalysisResults[i].deviceName===scenes[j].dataTimeValues[k].name){
  //   //           for(let m=0;m<scenes[j].dataTimeValues[k].timeValues.length;m++){
  //   //             if(scenes[j].dataTimeValues[k].timeValues[m][1]>0){
  //   //               canOn=true;
  //   //               break second;
  //   //             }
  //   //           }
  ...
  //   //     }
  //   //     if(!canOn){
  //   //       devicesNeverOn.push(scenes[0].deviceAnalysisResults[i].deviceName);
  //   //     }
  //   //   }
  ...
  //   //   for(let i=0;i<scenes[0].deviceAnalysisResults.length;i++){
  //   //     var deviceResult=this.scenes[0].deviceAnalysisResults[i];
  ...
  //   //         forth:
  //   //         for(let n=0;n<scenes[k].deviceAnalysisResults.length;n++){
  //   //           if(scenes[k].deviceAnalysisResults[n].deviceName===deviceResult.deviceName){
  //   //             for(let m=0;m<scenes[k].deviceAnalysisResults[n].deviceStateLastTime.statesTime.length;m++){
  //   //               if(stateName===scenes[k].deviceAnalysisResults[n].deviceStateLastTime.statesTime[m].stateName){
  //   //                 /////////////////////状态可发生/////////////////
  //   //                 stateHappen=true;
  //   //                 break third;
  //   //               }
  ...
  //   //   for(let i=0;i<scenes[0].deviceAnalysisResults.length;i++){
  //   //     var deviceName=scenes[0].deviceAnalysisResults[i].deviceName;
  //   //     var existConflict=false;
  //   //     second:
  //   //     for(let j=0;j<scenes.length;j++){
  //   //       third:
  //   //       for(let k=0;k<scenes[j].deviceAnalysisResults.length;k++){
  //   //         if(scenes[j].deviceAnalysisResults[k].deviceName===deviceName){
  //   //           if(scenes[j].deviceAnalysisResults[k].statesConflict.hasConflict){
  //   //             existConflict=true;
  //   //             break second;
  //   //           }
  //   //           break third;
  ...
  //   //       for(let k=0;k<scenes[j].deviceAnalysisResults.length;k++){
  //   //         if(scenes[j].deviceAnalysisResults[k].deviceName===deviceName){
  //   //           if(scenes[j].deviceAnalysisResults[k].statesChange.stateChangeFasts.length>0){
  //   //             /////////////////////设定多少次才算有效的变化频繁/此处为1/////////////////
  //   //             hasFastChange=true;
  //   //             break second;
  //   //           }
  ...
  //   //     second:
  //   //     for(let j=0;j<scenes[i].deviceAnalysisResults.length;j++){
  //   //       if(scenes[i].deviceAnalysisResults[j].deviceName===deviceName){
  //   //         ///////////////////看着设备的冲突是什么造成的////////

  //   //         if(scenes[i].deviceAnalysisResults[j].statesConflict.hasConflict){

  //   //           var conflictTimes=scenes[i].deviceAnalysisResults[j].statesConflict.conflictTimes;
  //   //           var deviceStateName=scenes[i].deviceAnalysisResults[j].deviceStateName;
  ...
  //   //             console.log("scene name: "+scenes[i].scenarioName)
  //   //             console.log("deviceName: "+deviceName)
  //   //             ///////////////////////单个scene下所有冲突及其原因
  //   //             var newStateCauseRuleList=[];
